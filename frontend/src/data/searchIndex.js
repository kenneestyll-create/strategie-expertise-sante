...
const IP_PGPF = [
  { title: "Incidence Professionnelle (IP)", description: "Indemnisation des consequences sur la carrière : pénibilité accrue, devalorisation, reconversion", category: "Indemnisation", href: "/ressources", anchor: "encyclopedie", keywords: ["incidence professionnelle", "ip", "pénibilité", "devalorisation", "reconversion", "carrière", "indemnisation", "prejudice", "emploi", "consequence", "impact", "travail", "profession"] },
  { title: "Perte de Gains Professionnels Futurs (PGPF)", description: "Compensation de la perte definitive de revenus après consolidation — capitalisation", category: "Indemnisation", href: "/ressources", anchor: "encyclopedie", keywords: ["pgpf", "perte de gains futurs", "perte de gains professionnels futurs", "capitalisation", "revenus", "bareme", "gazette du palais", "rente", "salaire", "consolidation", "projection", "manque a gagner"] },
  { title: "Critères IP — Pénibilité accrue", description: "Conditions de travail plus penibles dues aux séquelles : efforts supplementaires, douleurs", category: "Indemnisation", href: "/ressources", anchor: "encyclopedie", keywords: ["pénibilité", "accrue", "efforts", "douleur", "fatigue", "séquelles", "travail", "ip", "conditions", "souffrance"] },
  { title: "Critères IP — Devalorisation professionnelle", description: "Reduction de l'employabilite suite au handicap : discrimination, postes limites", category: "Indemnisation", href: "/ressources", anchor: "encyclopedie", keywords: ["devalorisation", "employabilite", "handicap", "discrimination", "embauche", "marche du travail", "ip", "chomage", "difficulté"] },
  { title: "Calcul PGPF — Méthode de capitalisation", description: "Projection de carrière, evolution salariale, impact du handicap, bareme de capitalisation", category: "Indemnisation", href: "/ressources", anchor: "encyclopedie", keywords: ["calcul", "pgpf", "capitalisation", "projection", "carrière", "salaire", "bareme", "euro de rente", "méthode", "montant", "estimation"] },
...
const GUIDES = [
  ...
  { title: "Guide : Comprendre le taux d'IPP", description: "Comment le taux est fixe et ses impacts sur l'indemnisation", category: "Guides", href: "/ressources#bibliotheque", keywords: ["guide", "ipp", "taux", "incapacité", "indemnisation", "calcul", "fixation", "bareme", "médecin", "évaluation", "pourcentage"] },
...
const INTENTS = [
  ...
  { title: "Consolidation — Definition", description: "Moment ou l'etat de santé est stabilise — point de depart des indemnisations definitives", category: "Sections", href: "/ressources", anchor: "glossaire", keywords: ["consolidation", "stabilisation", "guerison", "fin", "arret", "date", "definition", "etat", "santé", "séquelles"] },
