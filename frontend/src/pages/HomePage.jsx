            ...
            <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
              <div className="w-full max-w-[400px] relative">
                ...
                <div className="relative">
                  ...
                  <div className="absolute top-[12%] left-[-2%] flex items-center gap-2 sm:gap-2.5 bg-[#0c0c1a]/85 backdrop-blur-sm rounded-lg px-2.5 py-2 sm:px-3.5 sm:py-2.5 shadow-[0_0_20px_rgba(201,168,76,0.12)]" data-testid="hero-bloc-analyse">
                  ...
                  <div className="absolute top-[35%] right-[3%] flex items-center gap-2 sm:gap-2.5 bg-[#0c0c1a]/85 backdrop-blur-sm rounded-lg px-2.5 py-2 sm:px-3.5 sm:py-2.5 shadow-[0_0_20px_rgba(201,168,76,0.12)]" data-testid="hero-bloc-documents">
                    <div className="w-7 h-7 sm:w-9 sm:h-9 rounded-lg bg-[#C9A84C]/15 border border-[#C9A84C]/30 flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="absolute bottom-[25%] left-1/2 -translate-x-1/2 flex items-center gap-2 sm:gap-2.5 bg-[#0c0c1a]/85 backdrop-blur-sm rounded-lg px-2.5 py-2 sm:px-3.5 sm:py-2.5 shadow-[0_0_20px_rgba(201,168,76,0.12)]" data-testid="hero-bloc-orientation">
                    <div className="w-7 h-7 sm:w-9 sm:h-9 rounded-lg bg-[#C9A84C]/15 border border-[#C9A84C]/30 flex items-center justify-center flex-shrink-0">
