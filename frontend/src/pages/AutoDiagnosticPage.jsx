...
export const AutoDiagnosticPage = () => {
  ...
  return (
    <main className="page-transition pt-20">
      <SEO title="Diagnostic stratégique gratuit — 5 minutes" description="Un diagnostic personnalisé de votre situation : AT/MP, MDPH, expertise médicale, protection juridique. Rapport téléchargeable, 100% confidentiel." path="/auto-diagnostic" />
...
export default AutoDiagnosticPage;
