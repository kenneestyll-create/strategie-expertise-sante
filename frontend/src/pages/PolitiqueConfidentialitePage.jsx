...
import { Shield, Lock, Eye, Trash2, Mail, Server, FileText, Users } from 'lucide-react';
...
export const PolitiqueConfidentialitePage = () => {
  const sections = [
    ...
    },
    {
      ...
      content: "Les données de santé bénéficient d'une protection renforcée conformément à l'article 9 du RGPD. Elles sont traitées uniquement avec votre consentement explicite, dans le cadre strict de l'accompagnement administratif et stratégique. Elles ne sont jamais utilisées à des fins commerciales, de profilage, ou partagées avec des tiers sans votre accord préalable. Les analyses réalisées par nos outils d'aide (StratégiIA) ne constituent ni un diagnostic médical ni un avis médical."
    },
    {
      icon: Server, title: "6. Durée de conservation",
      content: null,
      list: [
        "Données de compte et de dossier : conservées pendant la durée de la relation contractuelle, puis 3 ans après le dernier contact",
        "Documents transmis : conservés pendant la durée de l'accompagnement, puis supprimés dans un délai de 6 mois sauf demande contraire",
        "Données de navigation : 13 mois maximum",
        "Données de facturation : 10 ans (obligation légale)"
      ]
    },
    {
      icon: Users, title: "7. Destinataires des données",
      content: "Vos données personnelles sont accessibles uniquement à l'équipe de Stratégie & Expertise Santé dans le cadre de l'accompagnement. Elles ne sont jamais vendues ni cédées à des tiers. Des sous-traitants techniques peuvent y avoir accès dans le cadre strict de la fourniture du service (hébergement, envoi d'emails), dans le respect du RGPD et sous contrat de sous-traitance."
    },
    {
      icon: Trash2, title: "8. Vos droits",
    ...
    {
      icon: Lock, title: "9. Sécurité des données",
      content: "Nous mettons en œuvre les mesures techniques et organisationnelles appropriées pour protéger vos données : chiffrement des communications (HTTPS/TLS), accès restreint et authentifié, hébergement sécurisé, sauvegardes régulières. En cas de violation de données, vous serez informé conformément aux obligations du RGPD."
    },
    {
      icon: Mail, title: "10. Contact",
      ...
      <section className="section-padding">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-sm text-muted-foreground mt-2">Dernière mise à jour : 14 mars 2026</p>
          </div>
