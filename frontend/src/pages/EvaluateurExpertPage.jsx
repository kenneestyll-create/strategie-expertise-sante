...
import { ShieldCheck, FileSearch, ScanSearch, FileCheck2, AlertTriangle, ArrowRight, Loader2, Lock } from 'lucide-react';
        ...
        <section className="p-6 rounded-xl border border-[#C9A84C]/30 bg-[#C9A84C]/5" data-testid="eval-start-section">
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              ...
              <p className="text-xs text-[#f5f0e8]/40 mt-1">Testez avec un cas de votre choix (anonymisé par vos soins). N'hésitez pas à chercher à mettre l'outil en défaut : vos critiques sont le livrable attendu.</p>
            </div>
