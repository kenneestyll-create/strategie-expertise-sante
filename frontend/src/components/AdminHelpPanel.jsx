...
const HELP_SECTIONS = [
  ...
  },
  {
    ...
    steps: [
      ...
      { label: 'Modèle & coûts', text: 'Claude Haiku 4.5 (Emergent LLM Key, prompt caching Anthropic). ~0,006 €/vidéo seule, ~0,011 €/vidéo+page SEO, ~0,003 €/voix off. Export .webm = 0 € (calcul navigateur). 100 vidéos+SEO+voix/mois = ~1,40 €/mois total. Aucune API externe payante.' },
