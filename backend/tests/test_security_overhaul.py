...
class TestCORSPolicy:
    ...
    def test_cors_returns_specific_origin_not_wildcard(self):
        ...
        headers = {
            "Origin": "https://secure-payment-flow-5.preview.emergentagent.com",
        ...
        if cors_header:
            assert cors_header in ["https://secure-payment-flow-5.preview.emergentagent.com", "http://localhost:3000"], \
