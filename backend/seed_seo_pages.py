...
},
{
    ...
    "content": {
        ...
        "reponse_rapide": "Le refus signifie que la CDAPH a accepté votre taux d'incapacité (entre 50 % et 79 %) mais refuse la Restriction Substantielle et Durable d'Accès à l'Emploi (RSDAE) — condition indispensable pour l'AAH au titre de l'article L.821-2 CSS. La formulation dans votre notification peut varier (« absence de RSDAE », « handicap n'interdit pas un emploi à mi-temps », ou code interne type « motif 6 » selon les MDPH) : le fond est le même. Vous disposez de 2 mois à compter de la notification pour déposer un Recours Administratif Préalable Obligatoire (RAPO). Un RAPO structuré en 3 piliers — médical, factuel, juridique — augmente significativement les chances de révision. Si le RAPO est rejeté, vous pouvez saisir le pôle social du tribunal judiciaire dans un nouveau délai de 2 mois.",
        "contexte": "L'AAH peut être attribuée selon deux voies (articles L.821-1 et L.821-2 du Code de la Sécurité Sociale) : un taux d'incapacité d'au moins 80 %, ou un taux compris entre 50 % et 79 % assorti d'une RSDAE reconnue. Lorsque la CDAPH accepte le taux mais refuse la RSDAE, elle rejette la demande au titre de l'article L.821-2 CSS. C'est un refus ciblé, pas une inéligibilité globale — et c'est précisément ce qui rend le recours techniquement jouable. Comment identifier ce refus dans votre notification ? La terminologie varie d'une MDPH à l'autre. On la retrouve sous différentes formes : « absence de restriction substantielle et durable d'accès à l'emploi » (la formulation la plus courante), « votre handicap n'interdit pas l'accès ou le maintien dans un emploi à au moins mi-temps », « capacités résiduelles jugées suffisantes pour un emploi adapté », ou encore des codes internes type « motif 6 » utilisés dans certains rapports d'instruction. Peu importe la formulation : dès lors que votre taux d'incapacité est reconnu entre 50 % et 79 % mais que l'AAH est refusée, vous êtes dans ce cas de figure, et la procédure de recours est identique.",
        "limites": "Les sites institutionnels (Service-public.fr, MDPH, CNSA) décrivent la RSDAE comme une restriction « substantielle et durable » d'accès à l'emploi. La définition reste volontairement souple. Ce qu'ils ne précisent pas, c'est que la CDAPH apprécie cette notion à partir des pièces fournies — pas de votre vécu. Concrètement : un certificat médical qui décrit un diagnostic sans détailler l'impact fonctionnel sur le travail (station debout, concentration, fatigabilité, contraintes horaires) sera lu comme une pathologie compatible avec un emploi adapté. Un projet de vie rédigé en quelques lignes génériques ne pèsera rien face à un dossier administratif standardisé. Le refus RSDAE reflète rarement la gravité réelle de votre situation — il reflète surtout les angles morts documentaires de votre dossier.",
        "blocages": [
        ...
        "strategie": "Un RAPO efficace repose sur trois étages complémentaires, pas sur la répétition du dossier initial. Pilier médical : un certificat actualisé rédigé par votre spécialiste (pas seulement le médecin traitant), détaillant les limitations fonctionnelles en lien explicite avec l'emploi — durée de station debout tolérée, capacité de concentration continue, fatigabilité post-effort, intolérances environnementales, effets des traitements en cours. Pilier factuel : la chronologie documentée de votre vie professionnelle — arrêts maladie, avis d'inaptitude de la médecine du travail, tentatives de reclassement, formations interrompues, bilans Pôle emploi ou Cap emploi. Chaque pièce doit être datée, nominative, cohérente avec la période décrite par le certificat médical. Pilier juridique : le rappel ciblé de l'article L.821-2 CSS (RSDAE) et de l'article L.114-1 CASF (définition du handicap), suivi d'une démonstration courte reliant vos pièces aux critères légaux. C'est le fond qui convainc, pas la longueur.",
        "orientation": [
        ...
        "reassurance": "Le refus AAH pour RSDAE non reconnue est l'une des décisions les plus contestables parmi les refus MDPH, précisément parce que la RSDAE laisse une marge d'appréciation importante à la CDAPH. Un dossier correctement restructuré, avec des pièces médicales ciblant l'emploi et une chronologie factuelle claire, peut faire basculer la décision au stade du RAPO — sans nécessairement passer par le tribunal.",
        "maillage": [
        ...
        "faq": [
            {"question": "Comment reconnaître un refus AAH pour RSDAE non reconnue ?", "answer": "Si votre notification indique un taux d'incapacité reconnu entre 50 % et 79 % mais refuse l'AAH, c'est que la RSDAE n'a pas été reconnue. Les formulations varient selon les MDPH (« absence de RSDAE », « handicap n'interdit pas un emploi à mi-temps », ou code interne type « motif 6 »). Le fond juridique et la procédure de recours sont identiques."},
            {"question": "Le silence de la MDPH après mon RAPO vaut-il acceptation ?", "answer": "Non. Le silence gardé pendant 2 mois sur un RAPO MDPH vaut rejet implicite (article R.421-2 CJA, applicable par renvoi). Dès ce rejet implicite, vous disposez de 2 mois pour saisir le pôle social du tribunal judiciaire."},
            {"question": "Puis-je contester le refus sans avocat ?", "answer": "Oui. Le RAPO est gratuit et ne nécessite aucun avocat. Devant le pôle social du tribunal judiciaire, l'assistance d'un avocat n'est pas obligatoire, mais un accompagnement stratégique (dossier, pièces, argumentaire) est un facteur déterminant."},
            {"question": "Quels documents médicaux ajouter dans un RAPO pour RSDAE ?", "answer": "Privilégiez un certificat médical actualisé rédigé par un spécialiste, décrivant les limitations fonctionnelles liées à l'emploi (durée de station, concentration, fatigabilité). Ajoutez les avis de la médecine du travail, les comptes rendus d'ergothérapie, de kinésithérapie, de psychologie si pertinents. Évitez la simple reconduction du certificat initial."},
            {"question": "Faut-il attendre la réponse au RAPO avant de saisir le tribunal ?", "answer": "Vous devez attendre soit la notification de rejet du RAPO, soit l'expiration du délai de 2 mois (qui vaut rejet implicite). Vous ne pouvez pas saisir le tribunal en même temps — le RAPO est un préalable obligatoire (article L.142-4 CSS)."},
            {"question": "La MDPH peut-elle rejeter mon RAPO avec les mêmes arguments ?", "answer": "Si vous redéposez le dossier identique, oui — le refus sera probablement confirmé. Mais si vous apportez des éléments nouveaux (certificats actualisés, chronologie professionnelle, avis spécialisés supplémentaires), la CDAPH est tenue de réexaminer la RSDAE à la lumière de ces pièces."},
            {"question": "Puis-je demander une expertise médicale indépendante ?", "answer": "Le médecin que vous consultez pour rédiger le certificat d'appui au RAPO ne doit pas être le médecin MDPH ayant instruit le dossier initial. Devant le tribunal judiciaire, une expertise médicale judiciaire peut être ordonnée — elle est alors contradictoire (article R.141-1 CSS)."},
            {"question": "Combien de temps dure la procédure complète ?", "answer": "Comptez 2 à 4 mois pour la réponse au RAPO selon la MDPH, puis 6 à 12 mois en moyenne pour une décision du pôle social si le recours contentieux est engagé. Le calendrier exact dépend de votre département."}
        ]
    },
},
# ═══════════════════════════════════════════════════════════════
...
async def seed_missing_only(db) -> dict:
    ...
    This preserves any manual edits made via admin UI / direct DB updates.
    ...
    for page_data in PAGES:
        slug = page_data["slug"]
        existing = await db.seo_pages.find_one({"slug": slug}, {"_id": 0, "slug": 1})
        if existing:
            skipped += 1
            continue
        doc = {
