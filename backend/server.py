...
async def _notify_admin_premium_analysis(analysis_type: str, email: str, name: str, amount: float):
    """Send admin notification when a premium analysis is ordered."""
    if not RESEND_AVAILABLE or not os.environ.get('RESEND_API_KEY') or not NOTIFICATION_EMAIL:
            ...
            try:
                ...
                resend.Emails.send({
                    ...
                    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                        ...
                        <p><a href="https://sante-aide.preview.emergentagent.com/contact" style="color: #0f3460;">Prendre rendez-vous</a></p>
...
async def dossier_express_checkout(request: Request):
    ...
    if analyse_premium:
        ...
        asyncio.create_task(_notify_admin_premium_analysis("dossier_express", email, name, amount))
...
async def strategiia_checkout(request: Request):
    ...
    if analyse_premium:
        ...
        asyncio.create_task(_notify_admin_premium_analysis("strategiia", email, "", amount))
...
SITE_URL = "https://sante-aide.preview.emergentagent.com"
