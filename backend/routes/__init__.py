...
from routes.expert_access import router as expert_access_router, admin_router as expert_access_admin_router
...
all_routers = [
    ...
    expert_access_router,
    expert_access_admin_router,
]
